...
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.65.tar.gz
...
%prep
%setup -q -n DateTime-TimeZone-2.65
cd %{_builddir}/DateTime-TimeZone-2.65
pushd ..
cp -a DateTime-TimeZone-2.65 buildavx2
popd
...
cp %{_builddir}/DateTime-TimeZone-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-TimeZone/c04d5e4462ecce92e616834488df5d1de6752488 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-DateTime-TimeZone/c04d5e4462ecce92e616834488df5d1de6752488
