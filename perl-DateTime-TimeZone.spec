...
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.57.tar.gz
...
%prep
%setup -q -n DateTime-TimeZone-2.57
cd %{_builddir}/DateTime-TimeZone-2.57
