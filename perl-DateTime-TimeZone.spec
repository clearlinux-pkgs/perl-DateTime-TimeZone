...
Version  : 2.56
Release  : 91
URL      : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.56.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.56.tar.gz
...
%prep
%setup -q -n DateTime-TimeZone-2.56
cd %{_builddir}/DateTime-TimeZone-2.56
...
cp %{_builddir}/DateTime-TimeZone-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-TimeZone/8174e9ce8604ab8777a24db0b17cbe082c7bba57 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-DateTime-TimeZone/8174e9ce8604ab8777a24db0b17cbe082c7bba57
