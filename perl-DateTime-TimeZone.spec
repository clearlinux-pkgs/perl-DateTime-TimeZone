...
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.64.tar.gz
...
%prep
%setup -q -n DateTime-TimeZone-2.64
cd %{_builddir}/DateTime-TimeZone-2.64
pushd ..
cp -a DateTime-TimeZone-2.64 buildavx2
popd
