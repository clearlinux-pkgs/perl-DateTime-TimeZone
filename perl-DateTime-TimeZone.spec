...
Source0  : https://cpan.metacpan.org/authors/id/D/DR/DROLSKY/DateTime-TimeZone-2.53.tar.gz
...
%prep
%setup -q -n DateTime-TimeZone-2.53
cd %{_builddir}/DateTime-TimeZone-2.53
